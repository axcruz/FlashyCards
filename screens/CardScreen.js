      ...
      <View style={[themeStyles.container, { justifyContent: 'center', alignItems: 'center' }]}>
        {currentIndex < totalCards ? (
          <>
            ...
            <View style={[themeStyles.card, { width: '100%', height: '50%'}, (showAnswer ? {borderColor: 'green'}: {borderColor: 'blue'}) ]}>
              <ScrollView>
            ...
            >
              {showAnswer ? (
              <Text style={[themeStyles.text, { color: "blue" }]}>Show Question</Text>
              ) : (
              <Text style={[themeStyles.text, { color: "green" }]}>Show Answer</Text>
              )}
            </TouchableOpacity>
