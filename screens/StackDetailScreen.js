      ...
      {stack ?
        <View style={themeStyles.container}>
          <View style={{ flexDirection: 'row', paddingBottom: 10, marginBottom: 10, borderBottomWidth: 1, borderBottomColor: 'gray' }}>
            ...
            <TouchableOpacity style={[themeStyles.dangerButton, { marginHorizontal: 5 }]} onPress={toggleDeleteModal}>
          ...
          >
            <View style={themeStyles.modalView}>
              <Text style={[themeStyles.titleText, { marginVertical: 10 }]}>Delete Stack</Text>
              <Text style={themeStyles.text}>Are you sure you want to delete this stack?</Text>
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
                <TouchableOpacity onPress={toggleDeleteModal} style={[themeStyles.configButton, { marginHorizontal: 5 }]}>
                  <Ionicons name="return-down-back" size={24} color="white" />
                </TouchableOpacity>
                <TouchableOpacity onPress={handleDeleteStack} style={[themeStyles.dangerButton, { marginHorizontal: 5 }]}>
